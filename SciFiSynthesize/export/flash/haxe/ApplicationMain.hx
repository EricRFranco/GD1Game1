...
@:dox(hide) class ApplicationMain {
	...
	public static function main () {
		...
		lime.system.System.__registerEntryPoint ("SciFiSynthesize", create);
		
		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed ("SciFiSynthesize", null, 640, 480);
		#end
		#else
		create (null);
		#end
		...
		var projectName = "SciFiSynthesize";
		
		var config = {
			
			build: "1",
			company: "HaxeFlixel",
			file: "SciFiSynthesize",
			fps: 60,
			name: "SciFiSynthesize",
			orientation: "",
	...
	public static function create (config):Void {
		...
		app.meta["file"] = "SciFiSynthesize";
		app.meta["name"] = "SciFiSynthesize";
